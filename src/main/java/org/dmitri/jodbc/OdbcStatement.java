...
public class OdbcStatement {
	...
	private Long bindDataRowSize=0L;//SQL_ATTR_ROW_BIND_TYPE size of wide-arrow element.  https://docs.microsoft.com/en-us/sql/odbc/reference/develop-app/binding-arrays-of-parameters?view=sql-server-ver15
	...
	public Object[] fetchScroll(OdbcFetchScrollType type, int rowOffset) {
		log.debug("JAVA fetchScroll {} {} {}", statementId, type, rowOffset);
